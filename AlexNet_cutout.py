...
fo = open("alex_batch_cutout.txt", "w")
...
#
#保存训练好的模型
torch.save(net.state_dict(),"./saved_alex_net_cutout.pt")
#绘制loss曲线于acc曲线
...
plt.savefig('./loss_curve_cutout.png')
plt.figure()#清空画板
plt.plot(epo,total_acc)
plt.xlabel('epoch')
plt.ylabel('acc')
plt.title('acc curve')
plt.savefig('./acc_curve_cutout.png')
